...
class AllSongsection extends ConsumerWidget {
  final String sectionName;
  const AllSongsection({super.key, required this.sectionName});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final songs = ref.watch(alphabeticalSongsProvider);
    return Padding(
...
final alphabeticalSongsProvider = FutureProvider<List<Song>>((ref) async {
  final homeServices = ref.read(homeServicesProvider);
  List<Song> songs = await homeServices.getSongs();
